...
python /scratch2/sdas/modules/pyannote-vtc-testing/main.py runs/train-superdataset-test-2_4-1/ apply \
...
--params runs/train-superdataset-test-2_4-1/best_params.yml
